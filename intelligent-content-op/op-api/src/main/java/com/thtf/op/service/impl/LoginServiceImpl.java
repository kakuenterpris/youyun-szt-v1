...
import com.thtf.op.mappings.BusSubCompanyInfoMapping;
import com.thtf.op.mappings.BusUserInfoMapping;
import com.thtf.op.mappings.LoginMapping;
import com.thtf.op.properties.ThtfLdapProperties;
import com.thtf.op.properties.WeaverProperties;
import com.thtf.op.repo.BusDepInfoRepo;
import com.thtf.op.repo.BusSubCompanyInfoRepo;
import com.thtf.op.repo.BusUserInfoRepo;
import com.thtf.op.service.LoginService;
import com.thtf.op.util.WeaverUtil;
...
public class LoginServiceImpl implements LoginService {
    ...
    public RestResponse syncUserInfo(String id) {
        ...
        return RestResponse.okWithMsg("同步同方OA用户信息成功");
    }
