...
public class MainTest {
     ...
     */
    private static final String APPID = "ec11-818d-45e2-a725-3e4c";
    private static final String USERID = "6740";

    public static void main(String[] args) {
        testRestful("https://oa.thtf.com.cn","/api/system/appmanage/route","");
        //获取token
//        testGetoken("https://oa.thtf.com.cn/");
    }
    /**
     * 第一步：
     *
