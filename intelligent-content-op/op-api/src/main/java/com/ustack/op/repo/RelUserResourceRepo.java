...
public interface RelUserResourceRepo extends IService<RelUserResourceEntity> {
    ...
    RelUserResourceDTO getOneByResourceId(Long resourceId);

    RelUserResourceDTO getOneByResourceFileId(Integer resourceFileId);

    List<RelUserResourceDTO> listByResourceFileIdList(List<Integer> resourceFileIdList);

    boolean deleteByResourceFileId(Integer resourceFileId);

    boolean deleteByResourceFileIdList(List<Integer> resourceFileIdList);
    ...
    List<RelUserResourceEntity> oneByField(String fileId, Integer resourceFileId);

    List<RelUserResourceEntity> getListByResourceIdList(List<Long> idList, String userId);
}
