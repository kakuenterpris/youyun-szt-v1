...
import com.thtf.feign.config.DsFeignAutoconfiguration;
 ...
 */
@FeignClient(name = "chat-api", url = "http://10.10.93.81/chat-api/", configuration = DsFeignAutoconfiguration.class)
