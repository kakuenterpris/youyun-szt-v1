package com.thtf.file.controller;

import cn.hutool.core.io.file.FileNameUtil;
import cn.hutool.core.util.IdUtil;
import com.thtf.file.dto.SyncFileDTO;
import com.thtf.file.service.impl.SystemPathFileUploadServiceImpl;
import com.thtf.file.dto.FileUploadBase64DTO;
...
public class FileUploadController {
    ...
    public RestResponse uploadFile( @RequestParam(value = "file") MultipartFile file,
        ...
        if (Arrays.stream(whiteList).noneMatch(s -> suffix.equals(s))){
