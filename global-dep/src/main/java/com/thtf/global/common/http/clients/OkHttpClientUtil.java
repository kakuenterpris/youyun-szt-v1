package com.thtf.global.common.http.clients;
...
public class OkHttpClientUtil {
    ...
    private static  final OkHttpClient okHttpClient = new OkHttpConfiguration().okHttpClient();
...
*/
    ...
    public static void main(String[] args) {
        //String s =OkHttpClientUtil.doPostJson("https://kmoa.test.oa.cnki.net/api/c/data/emp/positionRelation/list",
        // json,headers);
