...
public interface IFileUploadRecordRepo extends IService<FileUploadRecordEntity> {
     ...
     * @param entity
     * @author linxin
     * @return cloud.cnki.fileConversion.entity.FileUploadRecordEntity
     ...
     * @param guids
     * @author linxin
     * @return java.util.List<cloud.cnki.common.entity.FileUploadRecordEntity>
