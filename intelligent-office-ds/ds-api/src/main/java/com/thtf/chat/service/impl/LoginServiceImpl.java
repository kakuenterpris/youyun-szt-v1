...
public class LoginServiceImpl implements LoginService {
    ...
    public TfUserInfoResultDTO getHrmUserInfo(String token, String encryptUserid, int pagesize, int curpage) {
        ...
        HttpResponse res = HttpRequest.post("https://oa.thtf.com.cn/api/hrm/resful/getHrmUserInfoWithPage")
    ...
    public TfUserInfoResultDTO getJobtitleInfo(String token, String encryptUserid, int pagesize, int curpage) {
        String postJson = "{\n" +
                ...
                "}";
        //获取部门列表
        HttpResponse res = HttpRequest.post("https://oa.thtf.com.cn/api/hrm/resful/getJobtitleInfoWithPage")
                .header("appid", MainTest.getAppid())
                .header("token",token)
                .header("userid",encryptUserid)
                .body(postJson)
    ...
    public List<TfDepInfoDTO> getDepInfo(String token, String encryptUserid, int pagesize, int curpage) {
        String postJson = "{\n" +
                ...
                "}";
        //获取部门列表
        HttpResponse res = HttpRequest.post("https://oa.thtf.com.cn/api/hrm/resful/getHrmdepartmentWithPage")
                .header("appid", MainTest.getAppid())
                .header("token",token)
                .header("userid",encryptUserid)
                .body(postJson)
